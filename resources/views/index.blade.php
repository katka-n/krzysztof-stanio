        ...
        <div class="box clearfix"> 
            ...
            <nav class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
                <ul class="nav sf-menu clearfix">
                    <li class="active sub-menu"><a href="{{URL::to('/') }}">home</a><span></span>
                        <ul class="submenu">
...
<div class="bg_pic">
    <div class="container">
        <p class="title wow fadeInDown" data-wow-delay="0.2s">CHCESZ ZOSTAĆ <br>WEBDEVELOPEREM?</p>
...
<footer>
  ...
  More University Website Templates at <a rel="nofollow" href="http://www.templatemonster.com/category/university-website-templates/" target="_blank">TemplateMonster.com</a>
</footer>
