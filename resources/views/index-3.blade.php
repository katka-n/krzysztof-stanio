        ...
        <!--content-->
         <div class="container">
                <div class="col-lg-6 col-md-6 col-sm-6 box">
                    ...
                    <p class="center">Cras id justo euismod, congue eros in, pretium massa. Quisque id sodales liberoin
                        semper malesuada, nulla sapien pellentesque nulla, id ferm</p>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <ul class="list1-1">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 box">
                    ...
                    <p class="center">Quisque id sodales libero. Quisque ornare, tellus in semper malesuada, nulla
                        sapien pellentesque nulla, id fermen.</p>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <ul class="list1-1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        ...
                        <p>Vestibulum nec egestas massa. Donec vulputate, ligula eget vehicula tincidunt, nibh nulla
                            accumsan mauris, eget fringilla nisl nulla porta urna. </p>
