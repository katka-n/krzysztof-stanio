                                ...
                                <li>
                                    <div class="comment">
                                        ...
                                        <div class="dropdown_comments">
                                            <button class="btn-default btn1" onclick="myFunction({{ $comment['main']->id }})"><b>ODPOWIEDZ</b>
                                            </button>
                                            <div style="display:none;"
                                                ...
                                                <textarea class="form-control" name="comment" rows="4" cols="110"
                                                    ...
                                                    <button type="submit" class="btn-default btn1"><b>DODAJ</b></button>
                                            ...
                                            @foreach($comment['child']  as $child)
                                                <div class="reply">
                                                    ...
                                                    <div class="dropdown" style="font-size: 12px">
                                                        <button class="btn-default btn1" onclick="myFunction({{ $child->id }})">
