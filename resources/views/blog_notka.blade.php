                    ...
                    <div class="thumb-pad7 clearfix">
                        ...
                        <div class="extra-wrap">
                            ...
                            <div style="margin-top: 20px" class="button-section">
                                {!! Form::submit(trans('Dodaj'), ['id' => 'add-comment', 'class'=>'btn-default btn1']) !!}
                                {!! Form::close() !!}
                                    ...
                                    <li>
                                        <div class="comment">
                                            ...
                                            <div class="dropdown_comments">
                                                <button class="btn-default btn1"
                                                        onclick="myFunction({{ $comment['main']->id }})">
                                                    <b>ODPOWIEDZ</b>
                                                </button>
                                                ...
                                                <textarea class="form-control" name="comment" rows="4" cols="110"
                                                          placeholder="Komentarz"></textarea>
                                                            ...
                                                            <input style="width: auto" type="text"
                                                                   class="form-control form-nick"
                                                                   name="nick" placeholder="Podpisz się">
                                                        </div>
                                                        <button type="submit" class="btn-default btn1"><b>DODAJ</b>
                                                        </button>
                                            ...
                                            @if(isSet($comment['child']))
                                                @foreach($comment['child']  as $child)
                                                    <div class="reply">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 thumb-box4">
                                                            ...
                                                            <ul class="list1-1 indent">
                                                                @foreach($categories as $category)
                                                                    <li>
                                                                        <a href="/blog/kategoria/{{$category['name']}}">{{$category['name']}}</a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
                                                        ...
                                                        </div>           <div class="dropdown" style="font-size: 12px">
                                                            <button class="btn-default btn1"
                                                                    onclick="myFunction({{ $child->id }})">
